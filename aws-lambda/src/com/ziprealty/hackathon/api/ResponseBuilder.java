package com.ziprealty.hackathon.api;
...
public class ResponseBuilder {
    ...
    public static String getAddressFromRequest(LexRequest lexRequest) {
        String firstName = extractFirstName(lexRequest);
        String lastName = extractSurname(lexRequest);
        ...
        try {
            List<Address> addresses = JSONParser.parseJSONToAddress(sqlResponse.getMessage());
